...
(
    APPOINT_NO NUMERIC   PRIMARY KEY,
...
(
    DIAGNOS_NO NUMERIC PRIMARY KEY,
    ISSUE_DATE DATE,
...
(020, "Adol Syrup", 0.300, '2023/05/15'),
(021, "Amoxil Capsules", 0.700, '2023/03/10'),
(022, "Aspirin", 1.000, '2023/12/09'),
(023, "Bonjela Gel", 0.400, '2024/09/23'),
(024, "Paracetamol", 1.200, '2024/05/17'),
(025, "Atorvastatin", 1.500, '2023/06/15'),
(026, "Coversyl", 1.000, '2023/05/15'),
(027, "Diamicron", 0.900, '2024/02/03'),
(028, "Lipitor", 1.400, '2025/03/12'),
(029, "Glucophage", 1.700, '2024/07/19');
